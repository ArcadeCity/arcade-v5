...
storiesOf('Wallet - BalanceDetail', module)
  ...
  .add('In UseCase', () => (
    ...
    notes: 'BalanceDetail renders a View displaying information on a specific token such as icon, user balance, token price, value in dollars. Data is passed in as props: balanceObj of type Balance.'
  })
