...
storiesOf('Guilds - GuildDetail', module)
  ...
  .add(
    ...
    {
      notes:
        'GuildDetail renders a view with information about the guild name and mission and a button taking user to the guild profile. Button can be toggled off using the button prop',
    }
  )
