...
storiesOf('ModalContainer', module)
  ...
  .add('DEFAULT', () => <ModalContainer />, {
    notes:
      'ModalContainer renders an Animated View containing one of 6 modals depending on the name set in the modalStore. Available names are ADD_DETAILS, ADD_CARD, REQUEST_ACTIVE, REQUEST_BEGIN, REQUEST_CONFIRM, REQUEST_VIEW',
  })
  .add(
    'ADD_CARD',
    () => {
