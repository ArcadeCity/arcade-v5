...
storiesOf('Switch', module)
  ...
  .add(
    ...
    {
      notes:
        'Switch renders a toggle component. State (true or false) and onToggle are handled by the parent component and passed down as props: value of type boolean, onToggle of type function, and style of type ViewStyle. Additional styling to the track and thumb can be added with trackOnStyle, trackOffStyle, thumbOnStyle, and thumbOffStyle.',
    }
  )
