...
storiesOf('Icon', module)
  ...
  .add(
    ...
    {
      notes:
        'Icon renders a View of an Image based on the name prop provided. FontAwesome icons can also be rendered by pasing in the fontAwesome prop. Lastly, accepts an optional style prop to apply additional styling.',
    }
  )
