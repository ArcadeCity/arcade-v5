...
storiesOf('Button', module)
  ...
  .add(
    ...
    {
      notes:
        'Button styles can be overwritten by passing a style object into the style prop. Additionally text styles can be overwritten by passing a style object into the textStyle prop',
    }
  )
  .add(
    'Passing Content',
    ...
    {
      notes:
        'button text can be rendered by simply passing a string into the text prop or i18n translation key into the tx prop. Additionally, Button can render children components for further customization.',
    }
  )
  .add(
    'Interactive',
    () => (
      ...
      <Story>
        <UseCase text='Interactive' usage='Experiment with various props'>
          <Button
            ...
            withIcon={select(
              'withIcon',
              ['inbox', 'map', 'dollar', 'car', 'close', 'support'],
              ''
            )}
    ...
    {
      notes:
        'Button can be easily customized with variation on just a few props. Additional customization can be done with style overrides',
    }
  )
