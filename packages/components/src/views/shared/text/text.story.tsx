...
storiesOf('Text', module)
  ...
  .add(
    ...
    {
      notes:
        'Text processes content and renders a ReactNativeText component. Data is passed in as props: text of type string, tx of type translation key, txOptions type of i18n.TranslationOptions, preset of type TextPresetNames and capitalize of type boolean',
    }
  )
